...
<template>
  <div class="artworks">
    ...
    <br />
    <p>
      While AGI is idolized and fetishised, injured or murdered, subordinated
      and generally dramatised, varieties of artificial intelligence
      technologies infiltrate all spheres of life, reinforce human bias, and
      thus foster automated inequality in the present, making non-dystopian
      futures impossible to imagine. What kind of narratives do we need to shift
      and alter pop-cultural understanding of the artificial intelligences? How
    ...
    <p>
      ...
      cross-disciplinary project, which works on the intersection of music,
      performance, art, design and contemporary philosophy. Through experimental
      electronic music, spoken word and immersive setups, BBB_ seeks ambivalent
      situations taking place at the interface of the human and the inhuman
      existence and speculates on various states of mind, relationships and
